...
public:
	...
	ImGUI(vk::Device* pdevice, vk::CommandPool* pCommandPool, glm::vec2 size, GLFWwindow* window, VkRenderPass renderPass) :
		  device(pdevice)
	...
	void Init(float width, float height, GLFWwindow* window, VkRenderPass renderPass)
	{
