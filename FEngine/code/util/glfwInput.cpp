...
glm::vec2 Mouse::ScreenSpacePosition(glm::vec2 screenSize)
{
	glm::vec2 ratio = 2.f * Mouse::Position() / screenSize - glm::vec2(1.f, 1.f);
...
bool Mouse::ButtonPressed(int GLFW_MOUSE_BUTTON)
{
	return m_buttonsPressed[GLFW_MOUSE_BUTTON] == Input::FrameCount();
}
