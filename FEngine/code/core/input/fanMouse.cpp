...
namespace fan {
	//================================================================================================================================
	//================================================================================================================================
	void Mouse::SetCursor(CursorState _state)				{ glfwSetInputMode(Input::GetWindow(), GLFW_CURSOR, _state); }
	bool Mouse::GetButtonDown(int  _GLFW_MOUSE_BUTTON)		{ return glfwGetMouseButton(Input::GetWindow(), _GLFW_MOUSE_BUTTON) == GLFW_PRESS; }
	bool Mouse::GetButtonPressed(int _GLFW_MOUSE_BUTTON)	{ return Get().m_buttonsPressed[_GLFW_MOUSE_BUTTON] == Input::GetFrameCount(); }
	bool Mouse::GetButtonReleased(int _GLFW_MOUSE_BUTTON)	{ return Get().m_buttonsReleased[_GLFW_MOUSE_BUTTON] == Input::GetFrameCount(); }
