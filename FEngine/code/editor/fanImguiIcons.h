...
namespace ImGui {
	...
	enum IconType { 
		NONE = 0,
		RENDERER, IMAGE, INSPECTOR, PREFERENCES, CONSOLE, ECS, IMGUI, PROFILER, SCENE, GAMEOBJECT, GAMEOBJECT16, PREFAB32, PREFAB16,
		CAMERA, BOX_SHAPE, SPHERE_SHAPE, DIR_LIGHT, POINT_LIGHT, MATERIAL,MESH,RIGIDBODY,TRANSFORM, PARTICLES,
