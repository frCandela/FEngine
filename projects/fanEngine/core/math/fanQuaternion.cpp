...
namespace fan
{
    ...
    //==================================================================================================================================================================================================
    //==================================================================================================================================================================================================
    Fixed Quaternion::AngleBetween( const Quaternion& _q0, const Quaternion& _q1 )
    {
        return Fixed::ACos( _q0.mAngle * _q1.mAngle + Vector3::Dot( _q0.mAxis, _q1.mAxis ) );
    }

    //==================================================================================================================================================================================================
    //==================================================================================================================================================================================================
    Quaternion Quaternion::Slerp( const Quaternion& _q0, const Quaternion& _q1, const Fixed _lerp )
    {
        const Fixed angle = AngleBetween( _q0, _q1 );
        if( angle.IsFuzzyZero() )
        {
            return _q0;
        }
        const Fixed sinAngle = Fixed::Sin( angle );
        return ( Fixed::Sin( angle * ( 1 - _lerp ) ) / sinAngle ) * _q0 + ( Fixed::Sin( angle * _lerp ) / sinAngle ) * _q1;
    }
