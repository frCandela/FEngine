...
namespace fan
{
    ...
    ECS_SINGLETON( RenderDebug )
        ...
        std::vector<DebugVertex>     mDebugTrianglesNoDepthTest;
        ...
        void DrawTriangle( const Vector3& _v0, const Vector3& _v1, const Vector3& _v2, const Color _color, const bool _depthTestEnable = true );
        void DrawTriangles( const std::vector<Vector3>& _triangles, const std::vector<Color>& _colors, const bool _depthTestEnable = true );
        ...
        void DrawCone( const Transform& _transform, const Fixed _radius, const Fixed _height, const int _numSubdivisions, const Color _color, const bool _depthTestEnable = true );
