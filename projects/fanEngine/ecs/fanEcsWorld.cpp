...
namespace fan
{
    ...
    //==================================================================================================================================================================================================
    //==================================================================================================================================================================================================
    const EcsTagInfo* EcsWorld::SafeGetTagInfo( const uint32_t _type ) const
    {
        for( int i = 0; i < (int)mTagsInfo.size(); ++i )
        {
            const EcsTagInfo& tagInfo = mTagsInfo[i];
            if( tagInfo.mType == _type )
            {
                return &tagInfo;
            }
        }
