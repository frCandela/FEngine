...
namespace fan
{
    ...
    constexpr const char* GetEngineGroupName( const EngineGroups _group )
    {
        switch( _group )
        {
            case EngineGroups::None:
                return "None";
            case EngineGroups::Network:
                return "Network";
            case EngineGroups::Scene:
                return "Scene";
            case EngineGroups::SceneUI:
                return "SceneUI";
            case EngineGroups::ScenePhysics:
                return "ScenePhysics";
            case EngineGroups::SceneRender:
                return "SceneRender";
            case EngineGroups::Game:
                return "Game";
            case EngineGroups::GameNetwork:
                return "GameNetwork";
            case EngineGroups::Editor:
                return "Editor";
            default:
                return "Error";
        }
