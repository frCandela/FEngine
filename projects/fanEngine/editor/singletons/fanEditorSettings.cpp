...
namespace fan
{
    ...
    //==================================================================================================================================================================================================
    //==================================================================================================================================================================================================
    GuiSingletonInfo* EditorSettings::GetSingletonInfo( const uint32_t _type )
    {
        auto it = mSingletonInfos.find( _type );
        return it != mSingletonInfos.end() ? &( it->second ) : nullptr;
    }

    //==================================================================================================================================================================================================
    //==================================================================================================================================================================================================
    const GuiSingletonInfo* EditorSettings::GetSingletonInfo( const uint32_t _type ) const
    {
        auto it = mSingletonInfos.find( _type );
        return it != mSingletonInfos.end() ? &( it->second ) : nullptr;
    }
