...
namespace fan
{
    ...
    void TerrainAgent::Init( EcsWorld& /*_world*/, EcsEntity /*_entity*/, EcsComponent& _component )
    {
        ...
        agent.mMaxMoveSpeed     = 10;
        agent.mMaxRotationSpeed = 180;
        agent.mRange            = 2;
        ...
        agent.mSqrDistanceFromTarget = 0;
    ...
    void TerrainAgent::Save( const EcsComponent& _component, Json& _json )
    {
        ...
        Serializable::SaveFixed( _json, "move_speed", agent.mMaxMoveSpeed );
        Serializable::SaveFixed( _json, "rotation_speed", agent.mMaxRotationSpeed );
    ...
    void TerrainAgent::Load( EcsComponent& _component, const Json& _json )
    {
        ...
        Serializable::LoadFixed( _json, "move_speed", agent.mMaxMoveSpeed );
        Serializable::LoadFixed( _json, "rotation_speed", agent.mMaxRotationSpeed );
