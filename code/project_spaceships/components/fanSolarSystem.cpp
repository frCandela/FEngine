#include "project_spaceships/components/fanSolarSystem.hpp"
...
// 			if ( ImGui::DragFloat2( "scale min max", &m_scaleMinMax[ 0 ], 0.01f, 0.f, 1.f ) )
// 			{
// 			    if ( m_scaleMinMax[ 0 ] > m_scaleMinMax[ 1 ] ) { m_scaleMinMax[ 0 ] = m_scaleMinMax[ 1 ]; }
// 			}
