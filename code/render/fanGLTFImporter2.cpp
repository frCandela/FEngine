...
namespace fan
{
	//================================================================================================================================
	//================================================================================================================================
	GLTFImporter2::GLTFPrimitive::GLTFPrimitive( const Json& jPrimitive )
	{
	...
	//================================================================================================================================
	//================================================================================================================================
	GLTFImporter2::GLTFMesh::GLTFMesh( const Json& jMesh ) : primitive0( jMesh[ "primitives" ][ 0 ] )
	{
		name = jMesh[ "name" ];
	}
	...
	//================================================================================================================================
	//================================================================================================================================
	GLTFImporter2::GLTFBufferView::GLTFBufferView( const Json& _jView )
	{
	...
	//================================================================================================================================
	//================================================================================================================================
	GLTFImporter2::GLTFAccessor::GLTFAccessor( const Json& _jAccessor )
	{
	...
	//================================================================================================================================
	//================================================================================================================================
	GLTFImporter2::GLTFBuffer::GLTFBuffer( const Json& _jBuffer )
	{
	...
	//================================================================================================================================
	std::string GLTFImporter2::GLTFBuffer::GetBuffer( const GLTFBufferView& _view, const std::string& _decodedBuffer ) const
	{
	...
	//================================================================================================================================
	bool GLTFImporter2::Load( const std::string _path )
	{
		// Checks extension
	...
	//================================================================================================================================
	bool GLTFImporter2::GetMesh( Mesh2& _mesh )
	{
